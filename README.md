...
**CafeFinder** adalah aplikasi mobile berbasis **Flutter** yang dirancang untuk membantu mahasiswa dan pekerja *remote* menemukan tempat nugas (kafe) ternyaman di area Kota Palu. 

> Proyek ini merupakan hasil migrasi dan pengembangan lebih lanjut dari proyek UTS Android Studio (Java) sebelumnya.
...
```text
lib/
├── models/      # Definisi data (User, Cafe)
├── screens/     # UI Halaman (Login, Home, Explore, dsb)
├── services/    # Koneksi API & Logic Backend
